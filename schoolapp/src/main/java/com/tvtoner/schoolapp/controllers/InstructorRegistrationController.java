...
public class InstructorRegistrationController {
    ...
    @Autowired
    public InstructorRegistrationController(UserService userService) {
    ...
    @GetMapping("/showInstructorRegistrationForm")
    public String showMyLoginPage(Model theModel) {

        theModel.addAttribute("webUser", new WebUser());

        return "register/instructor-registration/registration-form";
    }

    @PostMapping("/processInstructorRegistrationForm")
    public String processInstructorRegistrationForm(
        ...
        userService.saveInstructor(theWebUser);
